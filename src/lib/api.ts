import { BrightSpaceApi, Criteria, Criterias } from './brightspace-assessment-scraper';

export default function BrightspaceApi(brightspaceBase, brightspaceApiBase): BrightSpaceApi {
    ...
    async function getRubricCriteria(organizationId, rubricId, jwt): Promise<Criterias> {
